        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ old('title', $post->title) }}" name="title"
                    class="form-control @error('title') is-invalid @enderror" id="title" autofocus required>
                @error('title')
            ...
            <div class="mb-3">
                ...
                @if($post->image)
                <img src="{{ asset("storage/{$post->image}") }}" class="img-preview d-block img-fluild mb-3 col-sm-5">
                @else
                <img src="" class="img-preview img-fluild mb-3 col-sm-5">
                @endif
...
// function previewImage() {
    ...
    function previewImage(){
        ...
        imagePreview.alt = image.files[0].name;
    }
